...
<div class="container">
    ...
    if ($Articulo->img != null) {
        echo"
            <video class='figure-img img-fluid rounded' src='http://localhost/ile{$Articulo->vid}' width='150' height='150'controls></video>
        ";
    };
    ?>
    </div>
