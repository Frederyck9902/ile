...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayTitulos = array(
        array('nombre' => 'TITULO I. GENERALIDADES.'),
        array('nombre' => 'TITULO II. EJERCICIO DE LA INGENIERIA, DE SUS PROFESIONES AFINES Y DE SUS PROFESIONES AUXILIARES.'),
        array('nombre' => 'TITULO III. DEL CONSEJO PROFESIONAL NACIONAL DE INGENIERIA Y SUS CORRESPONDIENTES REGIONALES O SECCIONALES.'),
        array('nombre' => 'TITULO IV. CODIGO DE ÉTICA PARA EL EJERCICIO DE LA INGENIERIA EN GENERAL Y SUS PROFESIONES AFINES Y AUXILIARES.'),
        array('nombre' => 'TITULO V. REGIMEN DISCIPLINARIO.'),
        array('nombre' => 'TITULO VI. DISPOSICIONES FINALES.')
    );

    private $arrayCapitulos = array(
        array('id_titulo'=>'1','nombre' => 'CAPITULO I. DEFINICIÓN Y ALCANCES.'),
        array('id_titulo'=>'2','nombre' => 'CAPITULO I. REQUISITOS PARA EJERCER LA INGENIERÍA, SUS PROFESIONES AFINES Y SUS PROFESIONES AUXILIARES.'),
        array('id_titulo'=>'2','nombre' => 'CAPITULO II. DEL EJERCICIO ILEGAL DE LA INGENIERÍA Y DE SUS PROFESIONES AFINES Y AUXILIARES.'),
        array('id_titulo'=>'2','nombre' => 'CAPITULO III. DE LOS PROFESIONALES EXTRANJEROS.'),
        array('id_titulo'=>'3','nombre' => 'CAPITULO I. DENOMINACIÓN, NATURALEZA JURÍDICA, INTEGRACIÓN Y FUNCIONES.'),
        array('id_titulo'=>'3','nombre' => 'CAPITULO II. DE LOS CONSEJOS REGIONALES O SECCIONALES.'),
        array('id_titulo'=>'4','nombre' => 'CAPITULO I. DISPOSICIONES GENERALES.'),
        array('id_titulo'=>'4','nombre' => 'CAPITULO II. DE LOS DEBERES Y OBLIGACIONES DE LOS PROFESIONALES.'),
        array('id_titulo'=>'4','nombre' => 'CAPITULO III. DE LAS INHABILIDADES E INCOMPATIBILIDADES DE LOS PROFESIONALES EN EL EJERCICIO DE LA PROFESIÓN.'),
        array('id_titulo'=>'5','nombre' => 'CAPITULO I. DEFINICIÓN, PRINCIPIOS Y SANCIONES.'),
        array('id_titulo'=>'5','nombre' => 'CAPITULO II. PROCEDIMIENTO DISCIPLINARIO.'),
        array('id_titulo'=>'6','nombre' => '')
    );

    private $arrayArticulos = array(
        array('id_capitulo'=>'1',
            'nombre' => 'ARTÍCULO 1o. CONCEPTO DE INGENIERÍA.',
            'contenido'=>'Se entiende por ingeniería toda aplicación de las ciencias físicas, químicas y matemáticas; de la técnica industrial y en general, del ingenio humano, a la utilización e invención sobre la materia.'),
        array('id_capitulo'=>'1',
            'nombre' => 'ARTÍCULO 2o. EJERCICIO DE LA INGENIERÍA.',
            'contenido'=>'Para los efectos de la presente ley, se entiende como ejercicio de la ingeniería, el desempeño de actividades tales como: 
            ...
            'contenido'=>'Para poder ejercer legalmente la Ingeniería, sus profesiones afines o sus profesiones auxiliares en el territorio nacional, en las ramas o especialidades regidas por la presente ley, se requiere estar matriculado o inscrito en el Registro Profesional respectivo, que seguirá llevando el Copnia, lo cual se acreditará con la presentación de la tarjeta o documento adoptado por este para tal fin. 
            ...
            'contenido'=>' Sólo podrán ser matriculados en el Registro Profesional de Ingenieros y obtener tarjeta de matrícula profesional, para poder ejercer la profesión en el territorio nacional, quienes: 
            ...
            'contenido'=>'Sólo podrán ser matriculados en el Registro Profesional respectivo y obtener certificado de inscripción profesional y su respectiva tarjeta, para poder ejercer alguna de las profesiones afines o de las profesiones auxiliares de la ingeniería en el territorio nacional, quienes: 
            ...
            'contenido'=>'El servidor público que en el ejercicio de su cargo, autorice, facilite, patrocine, encubra o permita el ejercicio ilegal de la ingeniería o de alguna de sus profesiones afines o auxiliares, incurrirá en falta disciplinaria, sancionable de acuerdo con las normas legales vigentes. 
            ...
            'contenido'=>'El particular que viole las disposiciones de la presente ley incurrirá, sin perjuicio de las sanciones penales y de policía, en multa de dos (2) a cincuenta (50) salarios mínimos mensuales legales vigentes. 
            ...
            'contenido'=>'Todo trabajo relacionado con el ejercicio de la Ingeniería, deberá ser dirigido por un ingeniero inscrito en el registro profesional de ingeniería y con tarjeta de matrícula profesional en la rama respectiva. 
            ...
            'contenido'=>'En adelante el Consejo Profesional Nacional de Ingeniería y sus Profesiones Auxiliares, se denominará Consejo Profesional Nacional de Ingeniería y su sigla será "Copnia" y tendrá su sede principal en Bogotá, D.C. 
            ...
            'contenido'=>'El Consejo Profesional Nacional de Ingeniería, Copnia, tendrá como funciones específicas las siguientes: 
            ...
            Sentencia C-570 de 2004, Corte Constitucional. El presente artículo fue declarado EXEQUIBLE por los cargos analizados.'),
            array('id_capitulo'=>'6',
            'nombre' => 'ARTÍCULO 27. CREACIÓN DE LOS CONSEJOS SECCIONALES Y REGIONALES.',
            'contenido'=>'Facúltase al Consejo Profesional Nacional de Ingeniería, Copnia, para que con el voto de la mayoría de los miembros de su Junta de Consejeros y mediante resolución motivada, suprima, fusione o cree sus respectivos Consejos Seccionales o regionales cuando lo estime conveniente, los cuales podrán no coincidir con la organización territorial de la República. 
            ...
            'contenido'=>'Las Juntas de Consejeros Regionales o Seccionales estarán integradas de la siguiente manera: 
            ...
            array('id_capitulo'=>'7',
            'nombre' => 'ARTÍCULO 30.',
            'contenido'=>'Los ingenieros, sus profesionales afines y sus profesionales auxiliares, para todos los efectos del Código de Ética Profesional y su Régimen Disciplinario contemplados en esta ley, se denominarán "Los profesionales".'),
            array('id_capitulo'=>'8',
            'nombre' => 'ARTÍCULO 31. DEBERES GENERALES DE LOS PROFESIONALES.',
            'contenido'=>'Son deberes generales de los profesionales los siguientes: 
            ...
            'contenido'=>'Son prohibiciones generales a los profesionales: 
            ...
            'contenido'=>'Son deberes especiales de los profesionales para con la sociedad: 
            ...
            'contenido'=>'on prohibiciones especiales a los profesionales respecto de la sociedad: 
            ...
            'contenido'=>'Son deberes de los profesionales de quienes trata este Código para con la dignidad de sus profesiones: 
            ...
            'contenido'=>'Son prohibiciones a los profesionales respecto de la dignidad de sus profesiones: 
            ...
            'contenido'=>'Son deberes de los profesionales para con sus colegas y demás profesionales de la ingeniería: 
            ...
            'contenido'=>'Son prohibiciones a los profesionales, respecto de sus colegas y demás profesionales de la ingeniería: 
            ...
            'contenido'=>'Son deberes de los profesionales para con sus clientes y el público en general: 
            ...
            'contenido'=>'Son prohibiciones a los profesionales respecto de sus clientes y el público en general: 
            ...
            'contenido'=>'Son deberes de los profesionales que se desempeñen en funciones públicas o privadas, los siguientes: 
            ...
            'contenido'=>'Son prohibiciones a los profesionales que se desempeñen en funciones públicas o privadas, las siguientes: 
            ...
            'contenido'=>'Son deberes de los profesionales en los concursos o licitaciones: 
            ...
            'contenido'=>'Son prohibiciones de los profesionales en los concursos o licitaciones: 
            ...
            'contenido'=>'Incurrirán en faltas al régimen de inhabilidades e incompatibilidades y por lo tanto se les podrán imponer las sanciones a que se refiere la presente ley: 
            ...
            'contenido'=>'Los profesionales de la ingeniería, de sus profesiones afines o de sus profesiones auxiliares, a quienes se les compruebe la violación de normas del Código de Ética Profesional adoptado en la presente ley, estarán sometidos a las siguientes sanciones por parte del Consejo Profesional de Ingeniería respectivo: 
            ...
            'contenido'=>'En la interpretación y aplicación del régimen disciplinario establecido prevalecerán, en su orden, los principios rectores que determina la Constitución Política, este código y el Código Contencioso Administrativo.'),
            array('id_capitulo'=>'10',
            'nombre' => 'ARTÍCULO 52. CRITERIOS PARA DETERMINAR LA GRAVEDAD O LEVEDAD DE LA FALTA DISCIPLINARIA.',
            'contenido'=>'El Consejo Profesional Seccional o Regional correspondiente de Ingeniería determinará si la falta es leve, grave o gravísima, de conformidad con los siguientes criterios: 
            ...
            'contenido'=>'Se consideran gravísimas y se constituyen en causal de cancelación de la matrícula profesional, sin requerir la calificación que de ellas haga el Consejo respectivo, las siguientes faltas: 
            ...
            'contenido'=>'El profesional que con una o varias acciones u omisiones infrinja varias disposiciones del Código de Ética Profesional o varias veces la misma disposición, quedará sometido a la que establezca la sanción más grave o, en su defecto, a una de mayor entidad.'),
            array('id_capitulo'=>'10',
            'nombre' => 'ARTÍCULO 55. CIRCUNSTANCIAS QUE JUSTIFICAN LA FALTA DISCIPLINARIA.',
            'contenido'=>'La conducta se justifica cuando se comete: 
            ...
            'contenido'=>'El investigado tendrá acceso a la queja y demás partes del expediente disciplinario, solo a partir del momento en que sea escuchado en versión libre y espontánea o desde la notificación de cargos, según el caso.'),
            array('id_capitulo'=>'10',
            'nombre' => 'ARTÍCULO 57. PRINCIPIO DE IMPARCIALIDAD.',
            'contenido'=>'El Consejo Profesional de Ingeniería respectivo, directamente o a través de sus Consejos Seccionales o Regionales, deberá investigar y evaluar, tanto los hechos y circunstancias desfavorables, como los favorables a los intereses del disciplinado.'),
            array('id_capitulo'=>'10',
            'nombre' => 'ARTÍCULO 58. DIRECCIÓN DE LA FUNCIÓN DISCIPLINARIA.',
            'contenido'=>'Corresponde al Presidente del Consejo Profesional de Ingeniería respectivo, la dirección de la función disciplinaria, sin perjuicio del impedimento de intervenir o tener injerencia en la investigación, en razón de tener que conocer en segunda instancia por vía de apelación o de consulta.'),
            array('id_capitulo'=>'10',
            'nombre' => 'ARTÍCULO 59. PRINCIPIO DE PUBLICIDAD.',
            'contenido'=>'El Consejo Profesional de Ingeniería respectivo respetará y aplicará el principio de publicidad dentro de las investigaciones disciplinarias; no obstante, ni el quejoso, ni terceros interesados se constituirán en partes dentro de estas.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 60. INICIACIÓN DEL PROCESO DISCIPLINARIO.',
            'contenido'=>'El proceso disciplinario de que trata el presente título se iniciará por queja interpuesta por cualquier persona natural o jurídica, la cual deberá formularse por escrito ante el Consejo Seccional o Regional del Consejo Profesional de Ingeniería respectivo, correspondiente a la jurisdicción territorial del lugar en que se haya cometido el último acto constitutivo de la falta o en defecto de este, ante el Consejo Seccional o Regional geográficamente más cercano. 
            ...
            'contenido'=>'Recibida la queja por el Consejo Seccional o Regional, a través de la Secretaría procederá a ordenarse la ratificación bajo juramento de la queja y mediante auto, ordenará la investigación preliminar, con el fin de establecer si hay o no mérito para abrir investigación formal disciplinaria contra el presunto o presuntos infractores. 
            ...
            'contenido'=>'Cuando existan razones para que se considere que se pueda entorpecer un proceso en determinado Consejo Seccional, el Consejo Nacional, podrá comisionar a otro Consejo Seccional, diferente del competente por jurisdicción territorial, el desarrollo del proceso disciplinario, para garantizar el cumplimento de todos los principios que lo rigen.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 63. INVESTIGACIÓN PRELIMINAR.',
            'contenido'=>'La investigación preliminar será adelantada por la respectiva Secretaría Seccional y no podrá excederse de sesenta (60) días, contados a partir de la fecha del auto que ordena la apertura de la investigación preliminar, durante los cuales se decretarán y practicarán las pruebas que el investigador considere pertinentes y que conduzcan a la comprobación de los hechos; las cuales podrán ser, entre otras, testimoniales, documentales, periciales, etc.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 64. FINES DE LA INDAGACIÓN PRELIMINAR.',
            'contenido'=>'La indagación preliminar tendrá como fines verificar la ocurrencia de la conducta, determinar si es constitutiva de falta disciplinaria e identificar o individualizar al profesional que presuntamente intervino en ella. 
            ...
            'contenido'=>'La decisión adoptada por el Consejo Profesional Seccional, se notificará personalmente al interesado, por intermedio de la Secretaría Seccional, dentro de los diez (10) días siguientes a la fecha de la sesión en que se adoptó y si no fuere posible, se realizará por edicto, en los términos del artículo 45 del Código Contencioso Administrativo.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 71. RECURSO DE APELACIÓN.',
            'contenido'=>'Contra dicha providencia solo procede el recurso de apelación ante el Consejo Profesional Nacional de Ingeniería respectivo, dentro de los cinco (5) días siguientes a la fecha de la notificación personal o de la desfijación del edicto recurso que deberá presentarse ante el Consejo Regional o Seccional por escrito y con el lleno de los requisitos que exige el Código Contencioso Administrativo.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 72. AGOTAMIENTO DE LA VÍA GUBERNATIVA.',
            'contenido'=>'El Consejo Profesional Nacional resolverá el recurso interpuesto, mediante resolución motivada; determinación que será definitiva y contra la cual no procederá recurso alguno por vía gubernativa.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 73. CONFIRMACIÓN.',
            'contenido'=>'En todo caso, el acto administrativo mediante el cual se dé por terminada la actuación de un Consejo Seccional dentro de un proceso disciplinario, deberá ser confirmado, modificado o revocado, según el caso, por el Consejo Profesional Nacional de Ingeniería correspondiente, por vía de apelación o de consulta.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 74. CÓMPUTO DE LA SANCIÓN.',
            'contenido'=>'Las sanciones impuestas por violaciones al presente régimen disciplinario, empezarán a computarse a partir de la fecha de la comunicación personal o de la entrega por correo certificado, que se haga al profesional sancionado de la decisión del Consejo Profesional Nacional correspondiente, sobre la apelación o la consulta.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 75. AVISO DE LA SANCIÓN.',
            'contenido'=>'De toda sanción disciplinaria impuesta a un profesional, a través de la Secretaría del Consejo Seccional respectivo, se dará aviso a la Procuraduría General de la Nación, a todas las entidades que tengan que ver con el ejercicio profesional correspondiente, con el registro de proponentes y contratistas y a las agremiaciones de profesionales, con el fin de que se impida el ejercicio de la profesión por parte del sancionado, debiendo estas, ordenar las anotaciones en sus registros y tomar las medidas pertinentes, con el fin de hacer efectiva la sanción. La anotación tendrá vigencia y solo surtirá efectos por el término de la misma.'),
            array('id_capitulo'=>'11',
            'nombre' => 'ARTÍCULO 76. CADUCIDAD DE LA ACCIÓN.',
            'contenido'=>'La acción disciplinaria a que se refiere el presente título caduca en cinco (5) años contados a partir de la fecha en que se cometió el último acto constitutivo de la falta. El auto que ordena la apertura de la investigación preliminar, interrumpe el término de caducidad. El proceso prescribirá tres años después de la fecha de expedición de dicho auto.'),
            array('id_capitulo'=>'11',
            ...
            array('id_capitulo'=>'12',
            'nombre' => 'ARTÍCULO 78. VIGENCIA.',
            'contenido'=>'La presente ley rige a partir de la fecha de su publicación en el Diario Oficial y deroga todas las disposiciones que le sean contrarias, en especial la Ley 20 de 1971, la Ley 14 de 1975, la Ley 64 de 1978, la Ley 28 de 1989, la Ley 33 de 1989, Ley 392 de 1997 y sus normas reglamentarias. 
    ...
    public function run()
    {
        ...
        self::seedTitulos();
		$this->command->info('Tabla títulos inicializada con datos!');
        self::seedCapitulos();
		$this->command->info('Tabla capítulos inicializada con datos!');
        self::seedArticulos();
		$this->command->info('Tabla artículos inicializada con datos!');       
    }

    public function seedTitulos(){       
        \DB::table('titulos')->delete();
        foreach( $this->arrayTitulos as $titulos ) {
            $t = new Titulo;
            $t->nombre = $titulos['nombre'];
            $t->save();
      }
    }

    public function seedCapitulos(){
        \DB::table('capitulos')->delete();
        foreach( $this->arrayCapitulos as $capitulos ) {
            $t = new Capitulo;
            $t->id_titulo = $capitulos['id_titulo'];
            $t->nombre = $capitulos['nombre'];
            $t->save();
      }
    }

    public function seedArticulos(){
        \DB::table('articulos')->delete();
        foreach( $this->arrayArticulos as $articulos ) {
            $t = new Articulo;
            $t->id_capitulo = $articulos['id_capitulo'];
            $t->nombre = $articulos['nombre'];
            $t->contenido = $articulos['contenido'];
            $t->save();
      }
    }
}
