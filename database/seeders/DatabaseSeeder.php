...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        self::seedLey();
		$this->command->info('Tabla ley inicializada con datos!');
    }

    public function seedLey(){
        \DB::table('leys')->delete();
        $l = new Ley;
        $l->ley='(Octubre 9) 
        ...
        CODIGO DE ÉTICA PARA EL EJERCICIO DE LA INGENIERIA EN GENERAL Y SUS PROFESIONES AFINES Y AUXILIARES. 
